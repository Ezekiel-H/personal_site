...
This assesment will look to see if it is theoreticly possible to make money changing NZD for BTC then to GBP and back to NZD via a BTC exchange. As a New Zealand born London resident I have a bank account in GBP and NZD so firstly lets look at the price of bitcoin over its recent history.
...
$$
$39.88 = \frac{$100}{((1.8925)  (.99))} ((1.3083)(.99))(1.982_{Current Azimo Rate}) - $100
$$
